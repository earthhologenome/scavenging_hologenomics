...
# Add text
circular_tree <-  circular_tree +
        annotate('text', x=3.8, y=0, label='            Phylum', family='arial', size=3.5) +
        annotate('text', x=4.4, y=0, label='                         Genome quality', family='arial', size=3.5) +
        annotate('text', x=5, y=0, label='                     Genome size', family='arial', size=3.5)
